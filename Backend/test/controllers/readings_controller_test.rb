...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post readings_url, params: { reading: { lat: @reading.lat, long: @reading.long, rDateTime: @reading.rDateTime, userId: @reading.userId } }, as: :json
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { lat: @reading.lat, long: @reading.long, rDateTime: @reading.rDateTime, userId: @reading.userId } }, as: :json
    assert_response 200
  end
